...
var style_LapakGIScomBatas_Kecamatan_BIG_PPBW_0 = function(feature, resolution){
    ...
    var value = feature.get("JML Nakes");
    var labelText = "";
    size = 0;
    ...
    if (value > 37.000000 && value <= 48.400000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 48.400000 && value <= 59.800000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 59.800000 && value <= 71.200000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 71.200000 && value <= 82.600000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 82.600000 && value <= 94.000000) {
            style = [ new ol.style.Style({
